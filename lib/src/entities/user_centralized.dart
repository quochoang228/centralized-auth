...
class UserCentralized {
  ...
  factory UserCentralized.fromRawJson(String str) =>
      UserCentralized.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory UserCentralized.fromJson(Map<String, dynamic> json) =>
      UserCentralized(
        exp: json["exp"],
        iat: json["iat"],
        jti: json["jti"],
...
class ResourceAccess {
  ...
  factory ResourceAccess.fromRawJson(String str) =>
      ResourceAccess.fromJson(json.decode(str));
